...
hospitals_df=spark.read.format("delta").load("dbfs:/pipelines/a1a88622-0cb4-4667-8d80-72c93d98559e/tables/hospitals_clean")
new_admissions_df=spark.read.format("delta").load("dbfs:/pipelines/a1a88622-0cb4-4667-8d80-72c93d98559e/tables/new_admissions_clean")
patient_history_df=spark.read.format("delta").load("dbfs:/pipelines/a1a88622-0cb4-4667-8d80-72c93d98559e/tables/patient_history_clean")
patients_df=spark.read.format("delta").load("dbfs:/pipelines/a1a88622-0cb4-4667-8d80-72c93d98559e/tables/patients_df_clean")
plans_df=spark.read.format("delta").load("dbfs:/pipelines/a1a88622-0cb4-4667-8d80-72c93d98559e/tables/plans_clean")
policies_new_df=spark.read.format("delta").load("dbfs:/pipelines/a1a88622-0cb4-4667-8d80-72c93d98559e/tables/policies_new_clean")
...
# MAGIC %sql
# MAGIC CREATE WIDGET TEXT TYPE_OF_ADMISSION_EMERGENCY_OR_OPD DEFAULT "E"
...
# MAGIC from new_admissions
# MAGIC where type_of_admission_emergency_or_opd == "$TYPE_OF_ADMISSION_EMERGENCY_OR_OPD"
# MAGIC group by date
...
# MAGIC %sql
# MAGIC create widget text OUTCOME default "EXPIRY"
...
# MAGIC join hospitals h on h.hosp_id=ndc.hospital_id
# MAGIC where type_of_admission_emergency_or_opd=="E" and outcome=="$OUTCOME"
...
dbutils.widgets.text("SECTOR","Public/Government","SECTOR")
